...
class TestLogin:
    ...
    def test_valid_login(self, username, password):
        ...
        self.test_valid_login = LoginPage(self.driver)
        self.test_valid_login.enter_username(username)
        time.sleep(2)
        self.test_valid_login.enter_password(password)
        time.sleep(2)
        self.test_valid_login.click_login()
        time.sleep(2)
